    ...
    return GetBuilder<ChallengePartyMainP>(
      builder: (challengePartyMain) {
        return
            ...
            //     controller: ChallengePartyMainP.refreshCont,
            //     onRefresh: () async {
            //       if (party != null) await challengePartyMain.init(party!.id!);
            //       ChallengePartyMainP.refreshCont.refreshCompleted();
            //     },
            //     onLoading: () async {
            //       await Future.delayed(const Duration(milliseconds: 100));
            //       ChallengePartyMainP.refreshCont.loadComplete();
            //     },
          ...
          // )
          // : ChallengePartyMainLoading(
          //     color: loadingP.color, party: party),
          //   );
          // },
        );
      },
              ...
              children: [
                ...
                Column(
                  children: [
                    SizedBox(height: 10.0.h),
                    Container(
                        width: 240.0.w, height: 20.0.h, decoration: decoration),
                    SizedBox(height: 10.0.h),
                  ],
                ),
                SizedBox(height: 10.0.h),
              ...
              children: [
                Column(
                  children: [
                    ...
                    Container(
                        width: 200.0.w, height: 30.0.h, decoration: decoration),
                    SizedBox(height: 5.0.h),
                  ],
                ),
                SizedBox(height: 30.0.h),
